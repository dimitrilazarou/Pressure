...
c      write(*,*)irmax
      ...
      write(massastring,'(i4)')imassa
      write(rmaxstring,'(i4)')irmax
      write(gstring,'(i2)')ig
      write(gwstring,'(i2)')igw
      write(grstring,'(i2)')igr
      nfile1='campiBAND_logVMbeta'//betastring//'ms'//massastring//'g'
     &//gstring//'gw'//gwstring//'gr'//grstring//
     &'R'//rmaxstring//'finden.out'
 
      nfile3='EnergieBANDAMIKEvsR_logVMbeta'//betastring//'ms'
     & //massastring//'g'
     &//gstring//'gw'//gwstring//'gr'//grstring//
     &'findenRELAX.out'
...
c      open(10,file='campi_ms550_LOGbeta13.out',status='old')
      open(10,file='campiansatzVM13ms1200g44gw10gr40R077.out'
     & ,status='old')
